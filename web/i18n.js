...
const UI = {
  en: {
    ...
    panelFree: "{0} KB free",
    panelName: "Robot name",
    panelRename: "Rename",
    renamed: "The robot is now called “{0}”.",
    badRobotName: "A robot name has 1 to 15 letters or digits, without ä, ö, ü or ß.",
    battery: "Battery: {0} V",
  ...
  de: {
    ...
    panelFree: "{0} KB frei",
    panelName: "Name des Roboters",
    panelRename: "Umbenennen",
    renamed: "Der Roboter heißt jetzt „{0}“.",
    badRobotName: "Ein Roboter-Name hat 1 bis 15 Buchstaben oder Ziffern, ohne ä, ö, ü oder ß.",
